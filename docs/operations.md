...
- Repository releases are attached to signed annotated tags such as `v0.2.0`.
- Panel package publications are attached to signed tags such as `lora-mailbox-panel-v0.2.0`.
